 ...
 */
@CommandDefinition(name = "http-server-enable-auth", description = "", activator = ConnectedActivator.class)
public class HTTPServerEnableAuthCommand extends AbstractEnableHTTPCommand {
