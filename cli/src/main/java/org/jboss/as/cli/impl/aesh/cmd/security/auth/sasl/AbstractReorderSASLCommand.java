 ...
 */
@CommandDefinition(name = "abstract-auth-sasl-re-order", description = "", activator = ConnectedActivator.class)
public abstract class AbstractReorderSASLCommand implements Command<CLICommandInvocation>, DMRCommand {
    ...
    @Option(name = MECHANISMS_ORDER, required = true, activator = OptionActivators.MechanismsOrderActivator.class,
